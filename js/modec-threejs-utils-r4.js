...
// TBD: Name? MDU - mition detector utilities? Namespace & objectification
	...
	MDU.headsUpClose = '<div class=normal ><div style="position:absolute;text-align:center;bottom:0px;width:100%;">[<i>make a fist to close</i>]</div>';
	MDU.headsUpAboutClose = '<div class=about ><div style="position:absolute;text-align:center;bottom:0px;width:100%;">[<i>make a fist to close</i>]</div>';
...
// pointer
	...
	// material = new THREE.MeshLambertMaterial();
			...
			loader.load( MDU.appRoot + 'models/hands/w-hand-02-01.js', function ( geometry ) {
...
// Canvas cheatsheet: http://www.nihilogic.dk/labs/canvas_sheet/HTML5_Canvas_Cheat_Sheet.png
		...
		context.fillStyle =  ( parameters.backgroundColor ) ? parameters.backgroundColor : 'white';
